@extends('layouts.app')
@section('title', 'Pilih Good Issue untuk Work Order')
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('production-qc.create') }}" method="GET">
                            <input type="hidden" name="t_good_issue_id" value="{{ $gi->id }}">
                            <button type="submit" class="btn btn-primary btn-sm">Buat WO</button>
                        </form>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="6">
                        <div class="empty-state" style="padding: 60px 20px;">
                            ...
                            <h4>Tidak ada Good Issue yang tersedia</h4>
                            <p>Semua Good Issue dengan target Part sudah memiliki Work Order.</p>
                        </div>
                    </td>
                </tr>
                @endforelse
