...
class GoodIssueController extends Controller
{
    ...
    {
        $stocks = Stock::with(['material', 'warehouse'])
        ...
        return view('good-issues.create', compact('stocks', 'parts', 'pics', 'autoNumber', 'project'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Pick warehouse from first item
...
{
    // Memuat data relasi yang diperlukan untuk cetak
    $goodIssue->load(['warehouse', 'part', 'pic', 'issuer', 'items.material', 'project']);
    
    // Mengembalikan view untuk print. 
    // Pastikan file view ini ada di: resources/views/good-issues/print.blade.php
